...
SRCS        = main.c events.c objparser.c parser_impl.c shaders.c skybox.c \
			  texture.c gl_math.c  m44.c drawing.c error.c frame_loop.c \
			  material.c mtlparser.c parse_utils.c submesh.c m44_projection.c
